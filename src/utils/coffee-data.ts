...
export const coffees: Coffee[] = [
  ...
  },
  {
    ...
    image: latte,
    title: 'Latte',
    description: 'One dose of espresso, two doses of milk, and creamy foam',
    price: '9.90',
    tags: ['TRADITIONAL', 'WITH MILK'],
  },
  {
    ...
    title: 'Capuccino',
    description:
      'Beverage made with cinnamon and equal doses of coffee, milk, and foam',
    price: '9.90',
    tags: ['TRADITIONAL', 'WITH MILK'],
  },
  {
  ...
  },
  {
    ...
    image: mochaccino,
    title: 'Mochaccino',
    description: 'Espresso coffee with chocolate broth, some milk and foam',
    price: '9.90',
    tags: ['TRADITIONAL', 'WITH MILK'],
  },
  {
  ...
  },
  {
    ...
    title: 'Irish',
    description:
      'Beverage made with coffee, Irish whisky, sugar and whipped cream',
    price: '9.90',
